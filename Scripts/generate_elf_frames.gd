...
## Génère body_elf_level_1_frames.tres depuis les PNGs LPC.
## Usage : Script > Exécuter (Ctrl+Shift+X)

const SRC  := "res://assets/elf-lvl-1/standard/"
const OUT  := "res://assets/sprites/placeholder/body_elf_level_1_frames.tres"
const FW   := 64
const FPS  := 8.0
...
const ANIMS := [
	["idle",   "walk.png",  1,  true,  false],  # frame 0 = debout avec tenue
	["run",    "walk.png",  9,  true,  false],
	["attack", "shoot.png", 13, false, false],
