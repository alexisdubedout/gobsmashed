...
## Génère body_mage_level_1_frames.tres depuis les PNGs LPC.
## Usage : Script > Exécuter (Ctrl+Shift+X)

const SRC  := "res://assets/mage-lvl-1/standard/"
const OUT  := "res://assets/sprites/placeholder/body_mage_level_1_frames.tres"
const FW   := 64
const FPS  := 8.0
...
const ANIMS := [
	...
	["attack", "spellcast.png", 7, false, false],
